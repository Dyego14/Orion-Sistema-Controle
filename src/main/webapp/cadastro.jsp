<%-- 
    Document   : cadastro
    Created on : 4 de jan. de 2026, 23:11:20
    Author     : Dyego
--%>
...
<html lang="pt-br">
<head>
    <title>Novo Tripulante - ORION</title>
...
<div class="cadastro-container">
    ...
    <div class="orion-header">
        <div class="orion-logo">NOVA RECRUTA</div>
        <div class="orion-subtitle">Adicione um novo membro à tripulação ORION</div>
    </div>

    <!-- Card de formulário -->
    <div class="card hologram">
        
        <h1>➕ Novo Tripulante</h1>

        <form action="usuarios" method="post" id="cadastroForm">
            <input type="hidden" name="action" value="create">

            <div class="form-group">
                <label><i class="fas fa-user-astronaut me-2"></i>Nome Completo</label>
                <div class="input-icon">
                    <input type="text" name="nome" required placeholder="Digite o nome do tripulante">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    <input type="email" name="email" required placeholder="tripulante@orion.com">
                    <i class="fas fa-at"></i>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    <select name="cargo" required>
                        ...
                        <option value="CAPITAO">👨‍✈️ Capitão</option>
                        <option value="ENGENHEIRO">🔧 Engenheiro</option>
                        <option value="QUIMICO">⚗️ Químico</option>
                        <option value="BIOLOGO">🧬 Biólogo</option>
                        <option value="GEOLOGO">⛰️ Geólogo</option>
